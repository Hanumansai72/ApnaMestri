                                ...
                                <motion.div key="details" initial={{ opacity: 0 }} animate={{ opacity: 1 }} exit={{ opacity: 0 }}>
                                    <ul className="list-unstyled">
                                        {keyFeatures.map((feature, index) => (
                                            <li key={index} className="mb-2"><i className="bi bi-check-circle-fill me-2 text-success"></i>{feature}</li>
                                        ))}
                                    </ul>
                                </motion.div>
                            )}
                                ...
                                <Col md={3} key={prod._id} className="mb-3">
                                    <Card className="related-product-card h-100">
                                        ...
                                        <Card.Body>
                                            ...
                                            <Button className="w-100 btn-add-to-cart" size="sm" onClick={() => navigate(`/product/${prod._id}`)}>View</Button>
                                        </Card.Body>
                                    </Card>
                                </Col>
                            ))}
