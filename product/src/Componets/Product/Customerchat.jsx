...
const socket = io("[https://backend-d6mx.vercel.app](https://backend-d6mx.vercel.app)"); // your backend URL
...
const res = await axios.get("[https://backend-d6mx.vercel.app/api/messages/all](https://backend-d6mx.vercel.app/api/messages/all)");
...
avatar: "[https://i.pravatar.cc/80?img=8](https://i.pravatar.cc/80?img=8)",
...
if (Object.values(unique).length > 0) setActiveId(Object.values(unique)[0].id);
};
loadConversations();
}, []);
...
return (
<> <NavaPro />
<div className="container-fluid" style={{ background: "#fff", minHeight: "100vh", padding: "1.25rem" }}> <div className="d-flex justify-content-between align-items-center mb-3"> <div className="d-flex gap-2">
<button className="btn btn-outline-secondary d-lg-none" onClick={() => setShowSidebar((s) => !s)}> <i className="bi bi-list"></i> </button>
<button className="btn btn-outline-secondary d-lg-none" onClick={() => setShowProfile((s) => !s)}> <i className="bi bi-person-circle"></i> </button> </div> </div>
                    ...
                    >
                      ...
                      <div className="ms-2 flex-fill">
                        ...
                        <div className="d-flex justify-content-between align-items-center">
                          ...
                          {conv.unread > 0 && (
                            <span className="badge rounded-pill" style={{ background: themeYellow, color: "#000" }}>
                              {conv.unread}
                            </span>
                          )}
                        </div>
